...
UPLOAD_FILEPATH = "C:/Users/AI/Desktop/test07251.walk"
...
def pretty_print_waypoints(waypoint_id, waypoint_name, short_code_to_count, localization_id):
    ...
    _str = "{} Waypoint name: {} id: {} short code: {}".format('->' if localization_id == waypoint_id else '   ', waypoint_name, waypoint_id, short_code)
    # print(_str)
    # print(
...
def update_waypoints_and_edges(graph, localization_id, do_print=True):
    ...
    if do_print:
        ...
        for waypoint in waypoint_to_timestamp:
            _str = pretty_print_waypoints(waypoint[0], waypoint[2], short_code_to_count, localization_id)
            strs.append(_str)
